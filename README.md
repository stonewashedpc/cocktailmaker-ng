...
This project was created following the steps at `https://github.com/dsyer/spring-boot-angular`
...
Run `mvnw clean package` to build a single executable jar. The jar can be found in `target/`.
